...
public class Camel implements Animal {
    ...
    public Camel(String name, ArrayList<String> commands, LocalDate dateOfBirth, LocalDate dateOfDeath) {
        this.name = name;
    ...
    public Camel(String name, ArrayList<String> commands, LocalDate dateOfBirth) {
        this.name = name;
        this.commands = commands;
        this.dateOfBirth = dateOfBirth;
